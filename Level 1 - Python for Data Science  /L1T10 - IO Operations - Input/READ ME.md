...
This program reads data from the provided "DOB.txt" text file and prints the names and birthdates in a formatted output.
...
The "DOB.txt" file, which you will provide, should be in the same directory as the "dob_task.py" file.  The file should contain name and birthdate information, formatted as follows (the program may need slight adaptation depending on the exact format):
...
3.  Place the  "DOB.txt" file in the same directory as `dob_task.py`.
